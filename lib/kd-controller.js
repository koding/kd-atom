...
import decorateMountFolder from './utils/decorate-mount-folder'
...
export default class KDController extends kd.Object {
  ...
  consumeTreeView(pkg) {
    ...
    this.subscriptions.add(
      atom.project.onDidChangePaths(this.decorateMounts.bind(this))
    )
  }

  decorateMounts() {
    this.treeView.roots.forEach(decorateMountFolder)
  }
